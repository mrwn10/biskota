...
document.addEventListener('DOMContentLoaded', () => {
    ...
    console.log('Biskota About page loaded successfully!');
});
...
document.addEventListener('DOMContentLoaded', () => {
    const sections = document.querySelectorAll('.brand-story, .health-benefits, .flavor-commitment, .location-section, .values-section, .team-section');
